...
public class CommandInterpreterAntonReMake {
    private ApplicationAntonReMake app;
    private Registry registry;
    private RegistryPersisterAntonReMake registrypersister;
    private RemoteRegistry remoteregistry;

    public CommandInterpreterAntonReMake(Registry registry, RemoteRegistry remoteregestry, RegistryPersisterAntonReMake registrypersister, ApplicationAntonReMake app){
